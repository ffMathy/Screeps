...
export default function profile(target: Function): void;
export default function profile(target: object, key: string | symbol, _descriptor: TypedPropertyDescriptor<Function>): void;
